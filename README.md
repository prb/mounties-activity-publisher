...
## Context
This application was "vibe-coded" by Claude Code based on the specification in [spec.md](spec.md) and some human interaction.  The implementation is intended to scrape backcountry skiing activities from the [Mountaineers](https://www.mountaineers.org/) website and publish summaries to a Discord channel.
